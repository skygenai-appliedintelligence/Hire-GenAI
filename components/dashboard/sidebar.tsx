...
import { LayoutDashboard, Briefcase, Users, Calendar, Settings, BarChart3, Building2, Phone, MessageSquare, Play, Bot, Brain } from 'lucide-react'
...
const navigation = [
  ...
  { name: "Demo & Testing", href: "/dashboard/demo", icon: Play },
